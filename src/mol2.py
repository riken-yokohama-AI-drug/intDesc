...
class Mol2:
    ...
    def __init__(self, interaction_type):
        ...
        Args:
            interaction_type (str): interaction computation target type
                                    Lig: Ligand-protein interactions
                                    Mut: Antibody-antigen interaction
                                    Met: Interaction of midium molecules
        """
        # Member that holds "@<TRIPOS>ATOM" information
        ...
        # Member holding "@<TRIPOS>BOND" information
        self.df_bond = pd.DataFrame(columns=["atom_id", "bond_atom_id", "bond_type"])

        # Member holding "@<TRIPOS>SUBSTRUCTURE" information
    ...
    def read_mol2(self, mol2_file):
        """Mol2 file read method

        Args:
            mol2_file (str): 3D structure information file (.mol2) path to calculate interaction descriptors
        """
        df_atom = None
        try:
        ...
        # Read processing of "@<TRIPOS>BOND" and "@<TRIPOS>SUBSTRUCTURE" sections
        ...
        # Assignment of atom framework information (backbone or sidechain).
        ...
        # Assignment of Chain information
    ...
    def add_molcular_type(self, molcular_select_file):
        """Methods for assigning molecular types

        Args:
            molcular_select_file (str): Interaction target molecule specification file
        """
